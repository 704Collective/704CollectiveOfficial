...
export default function CardNotFound() {
  return (
    <div className="min-h-screen bg-[#1A1A1A] flex flex-col items-center justify-center px-6 py-16">
      <p className="text-[#C6A664]/75 text-xs tracking-[0.35em] uppercase font-semibold mb-3">
        704 Collective
      </p>
      ...
      <Link
        ...
        className="mt-10 text-[#C6A664] text-sm font-medium hover:text-[#C6A664] transition-colors"
      >
