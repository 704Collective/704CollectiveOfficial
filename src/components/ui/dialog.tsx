  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "inset-0 h-[100dvh] max-h-[100dvh] translate-x-0 translate-y-0 overflow-y-auto rounded-none p-4",
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:h-auto sm:max-h-[min(90vh,800px)] sm:w-full sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:p-6",
        className
      )}
      {...props}
    >
